...
@section('sidebar')
    <ul  data-submenu-title="System">
        ...
        <li class="{{Request::is('admin/user*') ? 'active' : ''}}"><a href="{{route('admin.user.index')}}"><i class="icon-material-outline-supervisor-account"></i> Users</a></li>

    </ul>
    <ul  data-submenu-title="Account">
        <li class="{{Request::is('*profile*') ? 'active' : ''}}"><a href="{{route('admin.profile')}}"><i class="icon-material-outline-account-circle"></i> profile</a></li>
        <li class="{{Request::is('*followers*') ? 'active' : ''}}"><a href="{{route('admin.followers')}}"><i class="icon-feather-user-plus"></i> followers <span class="nav-tag followersCount">
